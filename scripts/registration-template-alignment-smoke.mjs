...
await page.addInitScript(({columns})=>{
  ...
  localStorage.setItem("journey-desk-state-v1",JSON.stringify({
    ...
    attendees:[{id:"alignment-1",attendeeType:"HCP",name:"季凡希",city:"上海",hospital:"上海市嘉定区中心医院",department:"内分泌科",title:"副主任医师",venue:"长沙",sex:"男",idNumber:"310123456789012345",phone:"13800000001",hcpId:"HCP-001",accommodation:"Y",flight:"Y",region:"上海大区",outboundTransferOrigin:"酒店",outboundTransferTime:"2026-09-03T12:00",outboundTransferNotes:"前台集合",returnTransferDestination:"公司",returnTransferTime:"2026-09-05T18:00",returnTransferNotes:"提前联系",businessStatus:"active",customFields:{},risks:[]}]
  }));
},{columns});
