...
await page.route("**/functions/v1/public-trip-query", async route => {
  ...
  const response = body.action === "authenticate" ? { authenticated:true, attendee:{ attendeeType:"HCP", name:body.name, region:body.region, phone:body.phone, accommodation:"Y", flight:"Y" } } : { completed:true, needsApproval:false };
...
const values = {city:"上海",hospital:"测试医院",department:"血液科",venue:"大连会场",sex:"女",idNumber:"TEST-ID-001",hcpId:"HCP-001",contactName:"测试销售",contactMobile:"13800008888",outDate:"2026-09-04",outFrom:"上海",outTo:"大连",outNo:"MU1001",outDeparture:"08:00",outArrival:"10:00",returnDate:"2026-09-06",returnFrom:"大连",returnTo:"上海",returnNo:"MU1002",returnDeparture:"18:00",returnArrival:"20:00"};
