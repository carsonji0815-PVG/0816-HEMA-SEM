...
assert.match(app,/function columnsWithJourneyFields\(columns\)/);
assert.match(app,/function exportExcel\(\)[\s\S]*?const exportColumns=columnsWithJourneyFields\(meetingTemplateColumns\(\)\)/);
