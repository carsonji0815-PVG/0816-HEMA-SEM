...
await page.fill('#transportBatchForm [name="terminal"]',"大连周水子机场");
await page.fill('#transportBatchForm [name="staffName"]',"测试工作人员");
await page.fill('#transportBatchForm [name="staffPhone"]',"13900000000");
if(await page.locator("#batchPointField").isVisible()) throw new Error("Pickup batch must not request a meeting point");
if(await page.locator("#batchTimeStrategyField").isVisible()) throw new Error("Pickup batch must not request service time");
