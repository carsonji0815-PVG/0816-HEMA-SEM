...
create table if not exists public.meetings (
  ...
  name text not null,
  activity_type text not null default 'external' check (activity_type in ('internal','external')),
...
create table if not exists public.attendees (
  ...
  depart_date date,
  depart_city text,
  depart_transport_type text check (depart_transport_type is null or depart_transport_type in ('PLANE','HIGH_SPEED_RAIL','LOCAL_ATTEND')),
  depart_station text,
  arrive_date date,
  arrive_city text,
  arrive_transport_type text check (arrive_transport_type is null or arrive_transport_type in ('PLANE','HIGH_SPEED_RAIL','LOCAL_ATTEND')),
  arrive_station text,
  return_depart_date date,
  return_depart_city text,
  return_depart_transport_type text check (return_depart_transport_type is null or return_depart_transport_type in ('PLANE','HIGH_SPEED_RAIL','LOCAL_ATTEND')),
  return_depart_station text,
  return_arrive_date date,
  return_arrive_city text,
  return_arrive_transport_type text check (return_arrive_transport_type is null or return_arrive_transport_type in ('PLANE','HIGH_SPEED_RAIL','LOCAL_ATTEND')),
  return_arrive_station text,
  verify_highlight_fields jsonb not null default '[]'::jsonb,
  out_date date,
  out_from text,
  out_to text,
  out_no text,
