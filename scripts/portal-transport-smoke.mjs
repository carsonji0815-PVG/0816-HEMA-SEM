...
if (!ruleText.includes("起飞前 2 小时") || !ruleText.includes("2026-09-06 16:40")) throw new Error("Flight dropoff recommendation failed");
...
if (!trainRuleText.includes("出发前 1.5 小时") || !trainRuleText.includes("2026-09-12 16:52")) throw new Error("Train dropoff recommendation failed");
