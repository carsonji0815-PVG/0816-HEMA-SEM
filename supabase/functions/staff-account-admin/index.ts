...
const cors={"Access-Control-Allow-Origin":"https://139.196.97.236","Vary":"Origin","Access-Control-Allow-Headers":"authorization, x-client-info, apikey, content-type","Access-Control-Allow-Methods":"POST, OPTIONS"};
