(() => {
  ...
  function roomingOccupancySheet(data=roomingOccupancyData()){
    const sheet=XLSX.utils.aoa_to_sheet(roomingOccupancyRows(data));sheet["!cols"]=[{wch:22},{wch:14},{wch:16},{wch:16}];return sheet;
  }
