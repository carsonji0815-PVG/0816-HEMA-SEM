(() => {
  ...
  const initialState = () => ({
    ...
    settings: {
      ...
      fieldConfig: { title:true, hcpId:true, accommodation:true, flight:true, mslContact:true, remarks:true, clothingSize:false, internalRoomingMode:"manual", registrationIdentityFields:[...DEFAULT_REGISTRANT_IDENTITY_FIELDS] },
