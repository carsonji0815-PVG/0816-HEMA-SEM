...
const path = ".tmp/browser/attendee-service-qr.png";
...
const borderPoints = [[0,0],[319,0],[0,319],[319,319],[16,160],[303,160],[160,16],[160,303]];
if (metadata.width !== 320 || metadata.height !== 320) throw new Error(`Unexpected QR size: ${metadata.width}x${metadata.height}`);
