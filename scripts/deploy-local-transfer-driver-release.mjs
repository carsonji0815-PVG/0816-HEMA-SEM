...
check('Guangzhou Baiyun T3 station installed',run('docker',['exec','lilly-stage-db','psql','-U','postgres','-d','postgres','-Atc',"select count(*) from public.station_dict where city_name='广州' and transport_type='PLANE' and station_name='广州白云国际机场T3航站楼' and station_short_name='广州白云 T3'"]).trim()==='1');
try{
