...
const project=open=>({slug:"hema-sem-2026",name:"HEMA SEM",startDate:"2026-09-04",endDate:"2026-09-06",venues:["大连会场"],registrationOpen:open,newRegistrationAllowed:open,managementOpen:true,templateImported:true,registrationTemplate:{version:1,columns:[{header:"姓名*",key:"name",required:true},{header:"手机号*",key:"phone",required:true},{header:"大区*",key:"region",required:true},{header:"联系人",key:"contactName"},{header:"联系人手机",key:"contactMobile"}]},fieldConfig:{quotaRegions:["华东","华南"]}});
