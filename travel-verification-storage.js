(function(root){
  'use strict';
  const fields={departDate:'depart_date',departCity:'depart_city',departTransportType:'depart_transport_type',departStation:'depart_station',arriveDate:'arrive_date',arriveCity:'arrive_city',arriveTransportType:'arrive_transport_type',arriveStation:'arrive_station',outDate:'out_date',outFrom:'out_from',outTo:'out_to',outNo:'out_no',outDeparture:'out_departure',outArrival:'out_arrival',returnDate:'return_date',returnFrom:'return_from',returnTo:'return_to',returnNo:'return_no',returnDeparture:'return_departure',returnArrival:'return_arrival'};
