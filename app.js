(() => {
  ...
  function rosterSupplementalColumns(list,templateColumns){
    ...
    const definitions=[
      ...
      {key:"outboundTransferOrigin",header:"去程送站出发地点",value:attendee=>attendee.outboundTransferOrigin||""},
      {key:"outboundTransferTime",header:"预约送站时间",value:attendee=>attendee.outboundTransferTime||""},
      {key:"outboundTransferNotes",header:"去程送站备注",value:attendee=>attendee.outboundTransferNotes||""},
      {key:"returnTransferDestination",header:"返程接站送达目的地",value:attendee=>attendee.returnTransferDestination||""},
      {key:"returnTransferTime",header:"预估接站时间",value:attendee=>attendee.returnTransferTime||""},
      {key:"returnTransferNotes",header:"返程接站备注",value:attendee=>attendee.returnTransferNotes||""},
    ];
